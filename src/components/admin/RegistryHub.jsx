...
const SECTORS = [
  ...
  { key:"trader", tag:"Trader & Processor", title:"Trader &\nProcessor", desc:"Trader and processor signup approvals and registry access.", to:"/admin/trader/dashboard", img:traderImg, accent:"0,170,230" },
];
