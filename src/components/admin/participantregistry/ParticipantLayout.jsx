...
import ParticipantSidebar from "../participantregistry/ParticipantSidebar";
import ParticipantHeader from "../participantregistry/ParticipantHeader";
  ...
  return (
    <div className={`min-h-screen bg-[#F5F9FF] ${sidePadding}`}>
      ...
      <div className="flex min-h-screen flex-col">
        <ParticipantHeader onToggleSidebar={handleToggleSidebar} />
