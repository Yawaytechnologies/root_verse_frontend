// src/components/admin/participantregistry/CratePackerListing.jsx
...
/* ══════════════════════════════════════
   Main Component — Listing only
══════════════════════════════════════ */
export default function CratePackerListing() {
  ...
  return (
    <div className="pccCratePackerList min-h-full" style={{ background: "#F7F5F2" }}>
      <style>{`
        .pccCratePackerList * { box-sizing: border-box; }
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 space-y-5">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold text-stone-900">Crate Packers</h1>
            <p className="mt-1 text-sm text-stone-500">All registered crate packer accounts</p>
          </div>
          <button
            type="button"
        ...
        {(listError || locError) && (
          <div className="flex items-center gap-2 rounded-2xl bg-rose-50 px-4 py-3 text-sm text-rose-700 ring-1 ring-rose-200">
            <FiAlertTriangle className="h-4 w-4 shrink-0" />{listError || locError}
          </div>
        )}
            ...
            {listLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-14 gap-2">
                ...
                <p className="text-xs text-stone-400">
                  {tableSearch ? "Try a different search term." : "No packers registered yet."}
                </p>
              </div>
          ...
          <div className="relative z-10 flex flex-col h-full
            ...
            <div className="flex items-center gap-3 border-b border-stone-100 px-5 py-4 shrink-0">
              ...
              <div>
                ...
                <p className="text-xs text-stone-500 font-mono">ID: {editPacker.id}</p>
              </div>
